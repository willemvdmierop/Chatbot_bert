...
ax[0].plot(x,df_q12[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score WD 0.01')
ax[0].plot(x,df_q11[0].rolling(window).mean(), color = 'red',label = 'BLEU score WD 0.001')
ax[0].plot(x,df_q13[0].rolling(window).mean(), color = 'blue', label = 'BLEU score WD 0.0001')
...
ax[1].plot(x,df_q22[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score WD 0.01')
ax[1].plot(x,df_q21[0].rolling(window).mean(), color = 'red', label = 'BLEU score WD 0.001')
ax[1].plot(x,df_q23[0].rolling(window).mean(), color = 'blue', label = 'BLEU score WD 0.0001')
...
ax[2].plot(x,df_q32[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score WD 0.01')
ax[2].plot(x,df_q31[0].rolling(window).mean(), color = 'red', label = 'BLEU score WD 0.001')
ax[2].plot(x,df_q33[0].rolling(window).mean(), color = 'blue', label = 'BLEU score WD 0.0001')
