...
ax[0].plot(x,df_q13[0].rolling(window).mean(), color = 'blue', label = 'BLEU score LR 0.00001')
...
ax[1].plot(x,df_q23[0].rolling(window).mean(), color = 'blue', label = 'BLEU score LR 0.00001')
...
ax[2].plot(x,df_q31[0].rolling(window).mean(), color = 'red', label = 'BLEU score LR 0.0001')
ax[2].plot(x,df_q33[0].rolling(window).mean(), color = 'blue', label = 'BLEU score LR 0.00001')
