...
metrics2 = torch.load("Metrics/metrics_hard_reset_not60ep")
metrics3 = torch.load("Metrics/metrics_WD_001_lr0001_Sched_True_60_epochs.pkl")
...
df_q11 = pd.DataFrame(Q1_metrics1).loc[:1805]
df_q21 = pd.DataFrame(Q2_metrics1).loc[:1805]
df_q31 = pd.DataFrame(Q3_metrics1).loc[:1805]

df_q12 = pd.DataFrame(Q1_metrics2).loc[:1805]
df_q22 = pd.DataFrame(Q2_metrics2).loc[:1805]
df_q32 = pd.DataFrame(Q3_metrics2).loc[:1805]

df_q13 = pd.DataFrame(Q1_metrics3).loc[:1805]
df_q23 = pd.DataFrame(Q2_metrics3).loc[:1805]
df_q33 = pd.DataFrame(Q3_metrics3).loc[:1805]
...
ax[0].plot(x,df_q11[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score LR 0.0001')
ax[0].plot(x,df_q12[0].rolling(window).mean(), color = 'red',label = 'BLEU score Hard reset')
ax[0].plot(x,df_q13[0].rolling(window).mean(), color = 'blue', label = 'BLEU score cosine warmup')
...
ax[1].plot(x,df_q21[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score LR 0.001')
ax[1].plot(x,df_q22[0].rolling(window).mean(), color = 'red', label = 'BLEU score Hard reset')
ax[1].plot(x,df_q23[0].rolling(window).mean(), color = 'blue', label = 'BLEU score cosine warmup')
...
ax[2].plot(x,df_q31[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score LR 0.001')
ax[2].plot(x,df_q32[0].rolling(window).mean(), color = 'red', label = 'BLEU score Hard reset')
ax[2].plot(x,df_q33[0].rolling(window).mean(), color = 'blue', label = 'BLEU score cosine warmup')
