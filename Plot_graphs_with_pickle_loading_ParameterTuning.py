...
metrics2 = torch.load("Metrics/metrics_hard_reset_60ep")
...
ax[0].plot(x,df_q12[0].rolling(window).mean(), color = 'yellow',label = 'BLEU score Cosine Hard reset')
...
ax[1].plot(x,df_q21[0].rolling(window).mean(), color = 'red', label = 'BLEU score LR 0.001')
ax[1].plot(x,df_q22[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score Cosine Hard reset')
...
ax[2].plot(x,df_q32[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score Cosine Hard reset')
