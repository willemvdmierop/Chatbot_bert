...
import pandas as pd
import numpy as np
metrics1 = torch.load("Metrics/metrics_scibert_lr0001_wd001_ep85")
metrics2 = torch.load("Metrics/metrics_SciBERT_lr0001_WD0001_ep100.pkl")
metrics3 = torch.load("Metrics/metrics_SCIBERT_lr001_wd0001_FINAL.pkl")
...
df_q11 = pd.DataFrame(Q1_metrics1).loc[:3569]
df_q21 = pd.DataFrame(Q2_metrics1).loc[:3569]
df_q31 = pd.DataFrame(Q3_metrics1).loc[:3569]

df_q12 = pd.DataFrame(Q1_metrics2).loc[:3569]
df_q22 = pd.DataFrame(Q2_metrics2).loc[:3569]
df_q32 = pd.DataFrame(Q3_metrics2).loc[:3569]

df_q13 = pd.DataFrame(Q1_metrics3).loc[:3569]
df_q23 = pd.DataFrame(Q2_metrics3).loc[:3569]
df_q33 = pd.DataFrame(Q3_metrics3).loc[:3569]
...
ax[0].plot(x,df_q11[0].rolling(window).mean(), color = 'red', label = 'BLEU score SciBERT LR 0.0001 WD 0.001')
ax[0].plot(x,df_q12[0].rolling(window).mean(), color = 'yellow',label = 'BLEU score SciBERT LR 0.0001 WD 0.001')
ax[0].plot(x,df_q13[0].rolling(window).mean(), color = 'blue', label = 'BLEU score SciBERT LR 0.001 WD 0.0001')
...
ax[1].plot(x,df_q21[0].rolling(window).mean(), color = 'red', label = 'BLEU score SciBERT LR 0.0001 WD 0.001')
ax[1].plot(x,df_q22[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score SciBERT LR 0.0001 WD 0.0001')
ax[1].plot(x,df_q23[0].rolling(window).mean(), color = 'blue', label = 'BLEU score SciBERT LR 0.001 WD 0.0001')
...
ax[2].plot(x,df_q31[0].rolling(window).mean(), color = 'red', label = 'BLEU score SciBERT LR 0.0001 WD 0.001')
ax[2].plot(x,df_q32[0].rolling(window).mean(), color = 'yellow', label = 'BLEU score SciBERT LR 0.0001 WD 0.0001')
ax[2].plot(x,df_q33[0].rolling(window).mean(), color = 'blue', label = 'BLEU score SciBERT LR 0.001 WD 0.0001')
